...
python3 marvel_api_02.py --dev /home/student/marvel.priv --pub /home/student/marvel.pub --hero Rogue
Needs a key file

Try issuing a few more calls. Each time, change the hero you search for. If you're not a Marvel fan, try out --hero Iceman, or --hero Archangel. Also try out some false tests, --hero Bicycle-Repairman and --hero Kalegirl should fail."""
